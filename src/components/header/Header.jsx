        ...
        <div className="container-fluid">
          ...
          <div className="ddList">
            <div className="dropdown">
              ...
              <div className="ddContent" style={{ marginLeft: "-50px" }}>
            ...
            <div className="dropdown">
              <button
                ...
                style={{ width: "170px" }}
              >
                Rooms & Suites<span className="arrow"></span>
              </button>
              <div
                className="ddContent"
              ...
              >
                <div className="row">
                  ...
                  <Link className="roomLink" style={{ marginLeft: "-10px" }}>
            ...
            <div className="dropdown">
              <button
                ...
                style={{ width: "120px" }}
              >
                Dinning<span className="arrow"></span>
              </button>
              <div
                className="ddContent"
            ...
            <div className="dropdown">
              ...
              <div className="ddContent" style={{ marginLeft: "-450px" }}>
                <div className="row">
                  <div className="column">
                    <h4>For Kids</h4>
            ...
            <div className="dropdown">
              ...
              <div className="ddContent" style={{ marginLeft: "-600px" }}>
                <div className="row">
                  <div className="column">
            ...
            <div className="dropdown">
              <button className="dropBtn" style={{ width: "110px" }}>
                Gallery
              </button>
            </div>
            <div className="dropdown">
            ...
            <div className="dropdown">
              ...
              <div className="ddContent" style={{ marginLeft: "-940px" }}>
                <div className="row">
                  <div className="column">
                    <h4>Apartments</h4>
